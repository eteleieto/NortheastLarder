...
This experiment is part of a general exploration into utilizing press cakes and agricultural byproducts. The goal is to produce a [[Garum|garum]] by leveraging the residual protein left in these press cakes to create an umami-rich sauce. This project compares two variations: one made with roasted [[Canola Press Cake|canola press cake]] and one with unroasted.
