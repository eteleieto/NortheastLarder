...
1. **Amazake is a natural sweetening agent.** In the United States, we rely heavily on refined cane sugar (or beet sugar), a pure white and heavily processed form of mostly sucrose. The sugarcane is mostly grown in the southern US, trucked to various east coast refineries, and then shipped again globally. Amazake has a more diverse nutrient profile with several types of B vitamins, is easier to digest & has low glycemic index (which minimizes blood sugar spikes).
