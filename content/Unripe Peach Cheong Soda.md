---
title: Unripe Peach Cheong Soda
tags:
  - RECIPE
  - SODA
date: 2025-07-30
...
This is an experiment to create a fermented soda using the previously made [[Unripe Peach Cheong|unripe peach cheong]]. A portion of the cheong is combined with water and an active [[Carrot Bug|carrot bug]] starter. The goal is to ferment the sugars from the cheong to produce a carbonated beverage.

---
## Recipe
--- start-multi-column: ID_1s9a
```column-settings
Number of Columns: 2
...
1.  **Combine**  
    Add the cheong, starter, and water to the jar.

2.  **Mix**  
    Stir thoroughly to dissolve the cheong syrup.

3.  **Ferment**  
    Seal the jar and leave it at room temperature for 12 to 24 hours.
...
![[Unripe Peach Cheong Soda.web.mp4|200|9:9]]
